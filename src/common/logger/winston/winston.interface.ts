...
export interface IWinstonHttpMiddleware extends Response {
  body: string;
}

export interface IWInstonHttpConfigOptions {
  readonly stream: RotatingFileStream;
}

export interface IWInstonHttpConfig {
  readonly debuggerHttpFormat: string;
  readonly debuggerHttpOptions?: IWInstonHttpConfigOptions;
}
